  ...
  const steps = [
    {
      ...
      description: "Message FamCare247 on WhatsApp to get instant access to stroke-care support.\nNo apps. No accounts. Just chat and go.",
    ...
    },
    {
      ...
      description: "From emergency signs to medications, rehab, diet, financial aid and more –\njust tap a menu option or type any question.",
    ...
    {
      number: "03",
      title: "Get 24/7 Caregiver Support", 
      description: "FamCare247 guides you day and night with simple, accurate, caregiver-friendly advice.\nYour caregiving companion, always ready.",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
            How it <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">Works</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Get started in minutes and see the impact on your stroke caregiving journey.
          </p>
        </motion.div>
